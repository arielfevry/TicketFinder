...
// API Paths
const LOGIN_PATH = '/api/auth/login.php';
const TICKETS_PATH = '/api/tickets.php';
const REGISTER_PATH = '/api/auth/register.php'
const MOVIES_PATH = '/api/movies.php';
const SHOWTIMES_PATH = '/api/showtimes.php';
